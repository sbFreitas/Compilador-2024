    ...
    public class Semantico : Constants
    {
        ...
        public void ExecuteAction(int action, Token token)
        {
            ...
            switch (action)
            {
                ...
                //case 129: Acao129(); break;
                //case 130: Acao130(); break;
        ...
        {
            Console.WriteLine($"Acao100");
        }

        private void Acao101()
        {
            Console.WriteLine($"Acao101");
        }
        ...
        private void Acao119()
        {
            ...
            //gera o código correspondente p/ bool se for false
            codigo.Add("ldc.i4.0");
        }
